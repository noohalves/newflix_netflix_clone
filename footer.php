			...
			<div class="social-links">
				<a class="social-link" href="#" target="_blank" aria-label="facebook">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-icon svg-icon-facebook-logo">
						<path fill-rule="evenodd" clip-rule="evenodd" d="M13.9868 13.1621V21.9841H10.0418V13.1621H6.8418V9.51207H10.0468V6.73207C10.0468 3.56707 11.9318 1.82007 14.8148 1.82007C15.7616 1.83321 16.7061 1.91577 17.6408 2.06707V5.17307H16.0448C15.4952 5.10007 14.9422 5.28088 14.5419 5.66447C14.1415 6.04807 13.9373 6.59284 13.9868 7.14507V9.51207H17.4868L16.9278 13.1621H13.9868Z" fill="currentColor">
						</path>
					</svg>
				</a>
				<a class="social-link" href="#" target="_blank" aria-label="instagram"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg-icon svg-icon-instagram-logo">
			...
			<ul class="member-footer-links">
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Idioma e legendas</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Audiodescrição</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Centro de ajuda</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Cartão pré-pago</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Imprensa</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Relações com investidores</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Carreiras</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Termos de uso</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Privacidade</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Avisos legais</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Preferências de cookies</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Informações corporativas</span>
					</a>
				</li>
				<li class="member-footer-link-wrapper">
					<a class="member-footer-link" href="#">
						<span class="member-footer-link-content">Entre em contato</span>
					</a>
				</li>
			</ul>
			<div class="member-footer-copyright">
				<span>© 2022 NewFlix, Inc.</span>
			</div>
		</div>

	
	<script type="text/javascript" src="js/areaprivada.js"></script>
